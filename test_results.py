...
def test_results(promotion_strategy, clf):
    test_data = pd.read_csv('C:\\Users\\John\\PycharmProjects\\Recommendation'
                            '-Engine\\data\\starbucks_test.csv')
    df = test_data[['V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V7']]
    promos = promotion_strategy(df, clf)
